...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        #print("*****************************sample.shape is ", sample.shape, len(down_block_res_samples),down_block_res_samples[0].shape)
        #print(abcd)
        
        # import copy
        # bottleneck = copy.deepcopy(sample)
        
        # 5. up
        cross_attns_list_list_list_dict = dict()
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                sample, cross_attns_list_list_list = upsample_block(
                    hidden_states=sample,
                    temb=emb,
                    ...
                    attention_mask=attention_mask,
                    external_hidden_states = external_hidden_states[str(i)] if external_hidden_states is not None else None,
                    encoder_attention_mask=encoder_attention_mask,
                )
                cross_attns_list_list_list_dict[str(i)] = cross_attns_list_list_list
            else:
        ...
        if not return_dict:
            ...
            return sample, cross_attns_list_list_list_dict
